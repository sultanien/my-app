    ...
    <div>
      ...
      <div className="hotel-page-container">
        ...
        <div className="hotel-page-wrapper">
          <button className="hotel-page-book-now">Reserve or Book Now!</button>
          <h1 className="hotel-page-title">Tower Street Apartments</h1>
          ...
          <div className="hotel-page-images">
            {photos.map((photo, i) => (
              <div className="hotel-page-img-wrapper" key={i}>
                <img onClick={()=> handleOpen(i)} src={photo.src} alt="" className="hotel-page-img" />
              </div>
            ))}
          </div>
          ...
          <div className="hotel-page-details">
            <div className="hotel-page-details-text">
              <h1 className="hotel-page-title">Stay in the heart of City</h1>
